...
> Veri kaynağı: `outputs_FINAL_1_2.zip` içindeki CSV’ler.
...
- **Format:** PDF (vektör) + PNG (300 dpi) birlikte üret.
...
> Not: Script, `outputs_FINAL_1_2.zip`’i açar, CSV’leri okur, fail-fast QC yapar, figürleri üretir.
...
- PDF (vektör) figürleri slayta yerleştir (en iyi kalite).
- Zorunlu ise PNG 300dpi kullan.
