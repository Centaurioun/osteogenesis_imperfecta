...
You can configure additional file locations for workspace instructions files with the
chat.instructionsFilesLocations

 setting. This is useful if you want to keep instructions files in a different folder or have multiple folders for better organization.
...
Run Settings Sync: Configure from the Command Palette (Ctrl+Shift+P).
...
Verify that your instructions file is in the correct location. A .github/copilot-instructions.md file must be in the .github folder at the root of your workspace. A *.instructions.md file must be in one of the folders specified in the
chat.instructionsFilesLocations
...
Select Chat: Configure Instructions from the Command Palette (Ctrl+Shift+P).
