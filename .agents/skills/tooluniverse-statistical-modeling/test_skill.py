...
def run_tests():
    ...
    try:
        ...
        abs(group_var - 4.0) < 3.0  # True random intercept var = 4 (sd=2)
    ...
    try:
        ...
        if both_finite:
            median_by_group[1] > median_by_group[0]
        else:
            pass  # Can't compare if one is inf
