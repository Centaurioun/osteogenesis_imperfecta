...
- Plan: `WORKSPACE_ORGANIZATION_PLAN.md`
- Claude handoff package: `CLAUDE_HANDOFF/README.md`
- Governance docs: `00_governance/docs/project_scope/`
- Prompts: `02_analysis/prompts/`

## Archive and provenance

- Inventory snapshot(s): `99_archive/snapshots/root_inventory_*.csv`
- Move logs: `99_archive/snapshots/move_log_*.csv`
- Archive lookup index: `99_archive/indexes/archive_lookup.csv`
- Date archive wave folder: `99_archive/by_date/2026-04-17_reorg_wave1/`

## Notes

- No files were deleted in this cleanup wave.
- Protected paths remained in place (`.git`, `.venv`, `.vscode`, `.github`, `.agents`, `.codex`).
