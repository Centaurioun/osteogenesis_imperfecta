# %% [markdown]
# # 🧬 Osteogenesis Imperfecta (Camber) Master Analysis - FINAL.1
...
try:
    ...
    pd.DataFrame(diff_report).to_csv(f'{OUT_DIR}/consistency_diff_FINAL_vs_FINAL_1.csv', index=False)
except Exception as e:
