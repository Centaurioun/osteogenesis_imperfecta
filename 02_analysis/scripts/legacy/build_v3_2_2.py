...
with open('oi_oro_dental_master_v3_2_2.py', 'w', encoding='utf-8') as f:
    f.write(py_code)
...
with open('oi_oro_dental_master_v3_2_2.ipynb', 'w', encoding='utf-8') as f:
    nbf.write(nb, f)

print("Running v3.2.2 pipeline...")
subprocess.run([sys.executable, 'oi_oro_dental_master_v3_2_2.py'], check=True)
